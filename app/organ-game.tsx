...
export default function OrganGame() {
  ...
  const start=useCallback((difficulty:Difficulty="normal")=>{
    ...
    if(dbg==="heart"||dbg==="brain"||dbg==="liver"){
      ...
      g.effect=`[debug] ${CORE_META[dbg].className} 각성 · B 보스 · N 잡몹 · K 정리 · H 회복 · I 무적`;g.effectT=6;
    }
